...
export const FeatureImageWrapper = styled.div`
    ...
    &.seven {
		background: linear-gradient(130deg, #59dbb0 0%, #ffa8e8 100%);
	}
    &.eight {
		background: linear-gradient(130deg, #e7d1ff 30%, #ffaf73 100%);
	}
    &.nine {
		background: linear-gradient(130deg, #e7d143 30%, #ffaf73 100%);
	}
