...
import {SiAltiumdesigner} from 'react-icons/SiAltiumdesigner'
...
export const featuresData = [
    ...
    {
		name: 'Aimation',
		description: '2D Animation,3D Animation',
		icon: iconStyle(MdOutlineAnimation),
		imgClass: 'seven',
	},
    {
		name: 'Frontend',
		description: '2D Animation,3D Animation',
		icon: iconStyle(SiFrontendmentor),
		imgClass: 'eight',
	},
    {
		name: 'Graphic',
		description: 'Graphic Designing',
		icon: iconStyle(SiAltiumdesigner),
		imgClass: 'nine',
	},
];