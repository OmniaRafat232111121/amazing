export const heroOne = {
	...
	backgroundColor: 'linear-gradient(	150deg,#c99ff -20%,#4a4eff)',
	start: 'true',
};
...
export const heroThree = {
	...
	linkTo: '/download',
	imgStart: '',
	backgroundColor: 'linear-gradient(104deg, rgba(151,40,218,1) 0%, rgba(183,17,205,1) 100%)',
...
export const heroFour = {
	...
	linkTo: '/more',
	imgStart: '',
	backgroundColor: 'linear-gradient(225deg,#0aba67,#b2de94)',
...
export const heroFive = {
	...
	linkTo: '/download',
	imgStart: '',
	backgroundColor: 'linear-gradient(104deg, rgba(21,10,218,1) 0%, rgba(90,8,185,1) 100%)',
	img: './images/content/lost.svg',
	start: 'true',
};
